...
public class RegisterIT {
	...
	public void ok_Full() {
		...
		register("test1@company.com", "Full Name 1", "1111");
		// all subsequent users get role of plain user
		register("test2@company.com", "Full Name 2", "2222");
		register("test3@company.com", "Full Name 3", "3333");
	}
	...
	public void fail_PasswordEmpty() {
		...
		setTextField("form:userBeanUserFullName", "fullName1");
